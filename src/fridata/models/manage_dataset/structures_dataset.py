...
from fridata.models.manage_dataset.compute_batches import ComputeBatches
...
from fridata.models.manage_dataset.index.handle_index import (
    create_index,
    add_new_files_to_index,
    read_index,
)
from fridata.models.manage_dataset.index.handle_indexes import HandleIndexes
from fridata.models.manage_dataset.sequences.sequence_and_coordinates_retriever import SequenceAndCoordinatesRetriever
...
from fridata.models.manage_dataset.distograms.generate_distograms import generate_distograms
from fridata.models.utils.from_archive import extract_batch_from_archive
from fridata.models.utils.create_client import create_client, total_workers
from fridata.utlis.filter_pdb_codes import filter_pdb_codes
from fridata.utlis.logging import log_title
...
class StructuresDataset(BaseModel):
    ...
    def generate_embeddings(self):
        ...
        from fridata.models.embedding.embedding import Embedding
