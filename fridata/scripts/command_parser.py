...
class CommandParser:
    ...
    def _create_dataset_from_path_(self) -> StructuresDataset:
        from fridata.models.manage_dataset.structures_dataset import StructuresDataset
        from fridata.models.utils.create_client import create_client
    ...
    def create_dataset(self):
        from fridata.models.manage_dataset.utils import format_time
    ...
    def read_distograms(self):
        from fridata.models.manage_dataset.distograms.generate_distograms import (
    ...
    def verify_chains(self):
        from fridata.models.chains.verify_chains import verify_chains

        self._create_dataset_from_path_()
        # CWD-relative: the caller must put pdb_seqres.txt in the working directory.
        # The file is not shipped with the package.
        verify_chains(self.structures_dataset, "./pdb_seqres.txt")

    def create_archive(self):
        from fridata.scripts.archive import create_archive
    ...
    def inspect_idx(self):
        from fridata.utlis.inspect_idx import inspect_idx

        inspect_idx(Path(self.args.file))

    def remove_dataset(self):
        from fridata.utlis.remove_dataset import remove_dataset
    ...
    def create_dashboard(self):
        ...
        from fridata.viewer.export_index_html import export_index_view
    ...
    def generate_data(self):
        from fridata.models.manage_dataset.structures_dataset import FatalDatasetError
